...
Nosso modelo 2 (homens) consegue explicar aproximadamente 44% da variação dos nossos dados. Mesmo sendo uma porcentagem menor que a encontrada para o nosso modelo 1 (mulheres) ainda podemos afirmar que nossa variável dependente (like) consegue ser bem explicada pelas características inteligente e divertido. 
